...
class Game:
    def __init__(self, width, height):  # Korrektur: Leerzeichen zwischen 'def' und '__init__' hinzugefügt
        pygame.init()
        self.width = width
        self.height = height
...
class Bullet:
    ...
    def check_collision(self, enemy):
        ...
        enemy_rect = enemy.enemy_img.get_rect(
            topleft=(enemy.x, enemy.y))  # Korrektur: 'enemy.enemy_img' verwendet anstelle von 'self.bullet_img'
        return bullet_rect.colliderect(enemy_rect)  # Korrektur: Richtige Kollisionserkennung
...
class Enemy:
    def __init__(self, game, x, y):
        ...
        self.y = y
        self.change_x = 5
        self.change_y = 60  # Korrektur: Variable 'change_y' eingefügt, da 'change_x' zweimal definiert war
        self.game = game
